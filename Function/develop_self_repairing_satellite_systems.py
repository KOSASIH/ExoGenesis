...
def develop_self_repairing_satellite_systems(data, labels):
    ...
    for self_repair_mechanism in ['health_monitoring', 'fault_diagnosis', 'fault_repair']:
        ...
        self_repairing_system = {
            'classifier': clf,
            'mechanism': self_repair_mechanism
        }
    ...
    self_repairing_system['mechanism'] = ['health_monitoring', 'fault_diagnosis', 'fault_repair'][best_self_repair_mechanism]
