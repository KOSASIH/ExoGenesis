...
def enable_autonomous_resource_refinement(data, labels):
    ...
    for refinement_mechanism in ['material_separation', 'material_refining', 'material_storage']:
        ...
        autonomous_system = {
            'regressor': regressor,
            'mechanism': refinement_mechanism
        }
    ...
    autonomous_system['mechanism'] = ['material_separation', 'material_refining', 'material_storage'][best_refinement_mechanism]
