...
energy_distribution_over_time = AstroMesh.simulate_energy_distribution(network, initial_energy_distribution, 100)
...
energy_transmission_over_time = AstroMesh.calculate_energy_transmission(communication_network, energy_distribution_over_time)
